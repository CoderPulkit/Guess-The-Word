...
function send() {
  ...
  inputbox="<br> Ans:<input type='text' id='input_chckbox'>";
  checkbtn="<br><br><button class='btn btn-info' onclick='check()'>Check</button>";
  row=question_word+inputbox+checkbtn;
...
function check() {
 get_ans=document.getElementById("input_chckbox").value;
 ans=get_ans.toLowerCase();
 console.log("Ans in LowerCase-" + ans);
 if (ans==word) {
